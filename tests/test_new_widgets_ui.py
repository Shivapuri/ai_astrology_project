...
def test_vimshottari_widget_renders(page):
...
def test_ashtakavarga_widget_renders(page):
...
def test_vimshopaka_widget_renders(page):
...
def test_ashtakavarga_view_mode_switching(page):
...
def test_nakshatras_widget_phase3_fields(page):
